...
public class Report_Set_MachineUploadGoodsConfirm extends Report {
    private static final long serialVersionUID = 1;

    public Report_Set_MachineUploadGoodsConfirm() {
        this.dataType = (byte) 17;
        this.bizType = (byte) 80;
    }

    public void setParams(String str, int i, int i2) {
        byte[] bytes = (Marker.ANY_MARKER + str + Marker.ANY_MARKER + i + Marker.ANY_MARKER + i2 + Marker.ANY_MARKER).getBytes();
