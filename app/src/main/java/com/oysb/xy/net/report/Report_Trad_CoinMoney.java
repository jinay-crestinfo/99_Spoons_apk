...
public class Report_Trad_CoinMoney extends Report {
    private static final long serialVersionUID = 1;

    public Report_Trad_CoinMoney() {
//        this.dataType = ClosedCaptionCtrl.MISC_CHAN_1;
        this.bizType = (byte) 66;
    }

    public void setParams(int i, int i2, int i3, int i4) {
        byte[] bytes = (Marker.ANY_MARKER + i + Marker.ANY_MARKER + i2 + Marker.ANY_MARKER + i3 + Marker.ANY_MARKER + i4 + Marker.ANY_MARKER).getBytes();
