...
//                        jSONObject.getString(AlipayConstants.TIMESTAMP);
                        ...
                        String string4 = jSONObject.getString("responseMsg");
...
//        }
        ...
        public void onFailure(RequestItem requestItem2, int i, String str15, Throwable th) {
            Loger.writeLog("SALES", str15);
            if (!th.getMessage().contains("") || ZaadPayHelper.listener == null) {
                return;
            }
            ZaadPayHelper.listener.onResult(false, "PreAuthorize", "", "");
        }
...
//                jSONObject.getString(AlipayConstants.TIMESTAMP);
                ...
                if (!string.equals("2001")) {
                    ...
                    String string5 = jSONObject2.getString("transactionId");
                    jSONObject2.getString("txAmount");
                    ZaadPayHelper.PreAuthorizeCommit("1.0", "", DateUtil.format(new Date(), "yyyy-MM-dd HH:mm:ss.SSS"), "WEB", "API_PREAUTHORIZE_COMMIT", string5, "Transaction Commited", "str8");
                }
            } catch (Exception unused) {
            }
            return false;
