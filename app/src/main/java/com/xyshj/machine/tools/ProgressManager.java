...
public class ProgressManager {
    ...
    /* renamed from: com.xyshj.machine.tools.ProgressManager$1 */
    /* loaded from: classes2.dex */
    ...
    private static WaitDialog createDialog(Context context, String str) {
        WaitDialog waitDialog = new WaitDialog(context, R.style.waitingDialogStyle);
        mProgress = waitDialog;
        waitDialog.setOnKeyListener(new DialogInterface.OnKeyListener() { // from class: com.xyshj.machine.tools.ProgressManager.1
            AnonymousClass1() {
            }
        ...
        if (str == null || str.length() == 0) {
            str = ShjAppHelper.getString(R.string.lab_waiting);
        }
    ...
    public static WaitDialog showProgress(Context context, String str) {
        ...
        try {
            ...
            initHander();
            new Timer().schedule(new TimerTask() { // from class: com.xyshj.machine.tools.ProgressManager.2
                AnonymousClass2() {
                }
    ...
    /* renamed from: com.xyshj.machine.tools.ProgressManager$2 */
    /* loaded from: classes2.dex */
    ...
    /* renamed from: com.xyshj.machine.tools.ProgressManager$3 */
    /* loaded from: classes2.dex */
    ...
    static void initHander() {
        if (h == null) {
            h = new Handler() { // from class: com.xyshj.machine.tools.ProgressManager.3
                AnonymousClass3() {
                }
    ...
    public static WaitDialog showProgress(Context context, String str, int i, OnShowMessageTimeoutListener onShowMessageTimeoutListener) {
        ...
        try {
            ...
            timer = timer4;
            timer4.schedule(new TimerTask() { // from class: com.xyshj.machine.tools.ProgressManager.4
                AnonymousClass4() {
                }
    ...
    /* renamed from: com.xyshj.machine.tools.ProgressManager$4 */
    /* loaded from: classes2.dex */
    ...
    public static void closeProgress(String str) {
        ...
        new Timer().schedule(new TimerTask() { // from class: com.xyshj.machine.tools.ProgressManager.5
            AnonymousClass5() {
            }
    ...
    /* renamed from: com.xyshj.machine.tools.ProgressManager$5 */
    /* loaded from: classes2.dex */
