...
public class CommoditySettingItem extends AbsMainSettingItem {
    ...
    public CommoditySettingItem(Context context, UserSettingDao userSettingDao, boolean z) {
        super(context, userSettingDao, z);
    }

    @Override // com.shj.setting.mainSettingItem.AbsMainSettingItem
    public String getName() {
        return this.context.getResources().getString(R.string.commodity_setting);
    }
