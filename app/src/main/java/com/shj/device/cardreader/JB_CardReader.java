...
public class JB_CardReader extends SerialDevice {
    ...
    private static JB_CardReader cardReader = new JB_CardReader();
    ...
    public static JB_CardReader get() {
        JB_CardReader jB_CardReader = cardReader;
        if (!jB_CardReader.inited) {
            jB_CardReader.setBaudrate(9600);
            cardReader.setDevPath("/dev/ttyS2");
            cardReader.inited = true;
            Timer timer2 = new Timer();
            timer = timer2;
            timer2.schedule(new TimerTask() { // from class: com.shj.device.cardreader.JB_CardReader.1
                AnonymousClass1() {
                }

                @Override // java.util.TimerTask, java.lang.Runnable
                public void run() {
                    if (!JB_CardReader.isCancled && System.currentTimeMillis() - JB_CardReader.lastStartPayTime > 10000) {
                        JB_CardReader.get().pay(JB_CardReader.lastShelf, JB_CardReader.lastPayMoney.intValue());
                    }
                }
            }, 2000L, 2000L);
        }
    ...
    /* renamed from: com.shj.device.cardreader.JB_CardReader$1 */
    /* loaded from: classes2.dex */
    ...
    */
    public void onMessage(byte[] r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.shj.device.cardreader.JB_CardReader.onMessage(byte[]):void");
    }
