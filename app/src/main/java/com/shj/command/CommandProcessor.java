...
public class CommandProcessor {
    ...
    Handler handler = new Handler() { // from class: com.shj.command.CommandProcessor.1
        AnonymousClass1() {
        }
    ...
    /* renamed from: com.shj.command.CommandProcessor$1 */
    /* loaded from: classes2.dex */
    ...
    public void start(Context context) {
        ...
        if (commandProcessRunnable == null || !commandProcessRunnable.run) {
            ...
            Loger.writeLog("COMMAND", "启动命令处理器");
